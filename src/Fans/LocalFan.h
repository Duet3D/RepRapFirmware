...
private:
	...
	static constexpr uint32_t TachoMaxInterruptCount = 16;	// number of tacho interrupts that we average over. We time out after 3 seconds, so a count of 16 allows us to read rpm down to (16/3) * (60/2) = 160.
