...
#if USE_FONT_CHIP
LcdILI9488::LcdILI9488(Pin fontCsPin, uint8_t sercomNum, uint32_t dataInPad, uint32_t dataOutPad) noexcept
	: TFTLcd(320, 480, fontCsPin, SpiMode::mode0, sercomNum, dataInPad, dataOutPad)
#else
LcdILI9488::LcdILI9488(const LcdFont * const fnts[], size_t nFonts, uint8_t sercomNum, uint32_t dataInPad, uint32_t dataOutPad) noexcept
	: TFTLcd(320, 480, fnts, nFonts, SpiMode::mode0, sercomNum, dataInPad, dataIutPad)
#endif
{
}
