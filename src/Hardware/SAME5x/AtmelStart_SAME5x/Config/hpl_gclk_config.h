 ...
 * GCLK1 is fed from DPLL0, divisor 2, frequency 60MHz. It is used to clock SERCOM (max 100MHz), ADC (max 100MHz), TCC, and TC devices (some TCs are max 100MHz)
 * GCLK1 is fed from DPLL1, divisor 1, frequency 48MHz. It is used to clock CAN
 */
