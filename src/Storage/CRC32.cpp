...
{
#if USE_SAME5x_HARDWARE_CRC
	// This is very inefficient because of the call to TaslCriticalSectionLocker, but I don't think we use this function anyway.
