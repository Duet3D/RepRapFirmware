...
const FileInfoParser::ParseTableEntry FileInfoParser::parseTable[] =
{
	...
	{	"generated by",								&FileInfoParser::ProcessGeneratedBy,		0 },		// slic3r and S3D
	...
	{ 	"layer_height",								&FileInfoParser::ProcessLayerHeight,		0 },		// slic3r
	{ 	"Layer height",								&FileInfoParser::ProcessLayerHeight,		0 },		// Cura
	{ 	"layerHeight",								&FileInfoParser::ProcessLayerHeight,		0 },		// S3D
	...
	{	"filament used [mm]",						&FileInfoParser::ProcessFilamentUsed,		0 },		// Prusa slicer
	{	"filament used",							&FileInfoParser::ProcessFilamentUsed,		0 },
	{	"Filament used",							&FileInfoParser::ProcessFilamentUsed,		0 },
	{	"Filament length",							&FileInfoParser::ProcessFilamentUsed,		1 },		// S3D v4 ??? CHECK CASE OF FIRST LETTER
	...
	{	"Material#",								&FileInfoParser::ProcessFilamentUsed,		4 },		// Ideamaker e.g. ";Material#1 Used: 868.0"
	{	"Extruder",									&FileInfoParser::ProcessFilamentUsed,		5 },		// Fusion 360 e.g. ";Extruder 1 material used: 1811mm"
};
