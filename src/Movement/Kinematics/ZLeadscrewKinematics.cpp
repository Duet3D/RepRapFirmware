...
bool ZLeadscrewKinematics::DoAutoCalibration(unsigned int msNumber, size_t numFactors, const RandomProbePointSet& probePoints, const StringRef& reply) noexcept
{
