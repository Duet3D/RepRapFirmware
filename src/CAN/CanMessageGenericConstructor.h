...
public:
	...
	GCodeResult SendAndGetResponse(CanMessageType msgType, CanAddress dest, const StringRef& reply, uint8_t *_ecv_null extra = nullptr, uint32_t *_ecv_null words = nullptr) const noexcept;
