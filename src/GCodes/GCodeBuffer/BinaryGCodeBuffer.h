...
{
public:
	BinaryGCodeBuffer(const char* id, MessageType mt, bool useCodeQueue);
	...
	void Put(const char *data) override;				// Add a null-terminated string, overwriting any existing content
