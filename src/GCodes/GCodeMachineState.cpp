...
GCodeMachineState::GCodeMachineState() noexcept
	: feedRate(ConvertSpeedFromMmPerMin(DefaultFeedRate)),
	  ...
	  waitingForAcknowledgement(false), messageAcknowledged(false), localPush(false), macroRestartable(false), firstMoveAfterRestart(false),
#if HAS_LINUX_INTERFACE
...
GCodeMachineState::GCodeMachineState(GCodeMachineState& prev, bool withinSameFile) noexcept
	: feedRate(prev.feedRate),
	  ...
	  waitingForAcknowledgement(false), messageAcknowledged(false), localPush(withinSameFile), firstMoveAfterRestart(prev.firstMoveAfterRestart),
#if HAS_LINUX_INTERFACE
