...
- [done] When IS is enabled we get quite a lot of speed discontinuities.
- [done] Setting PA to 0 or much below 0.2 makes it sound horrible.
- [done] Could some of the discontuuities be caused by PA being on/off for adjacent printing moves and retraction moves?
