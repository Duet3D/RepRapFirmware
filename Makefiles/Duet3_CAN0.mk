...
DUET3CAN0_LIBCPP_SRCS := $(call rwildcard,$(DUET3CAN0_SRC_DIR)/libcpp,*.cpp *.cc)
DUET3CAN0_LIBC_SRCS := $(call rwildcard,$(DUET3CAN0_SRC_DIR)/libc,*.c *.cpp)

# Directories excluded from the source scan, mirroring the Eclipse source folder exclusions
DUET3CAN0_EXCLUDE_DIRS := \
	$(DUET3CAN0_SRC_DIR)/libc \
	$(DUET3CAN0_SRC_DIR)/Networking/LwipEthernet/Lwip/src/apps/smtp \
	$(DUET3CAN0_SRC_DIR)/Networking/LwipEthernet/Lwip/src/apps/snmp \
	$(DUET3CAN0_SRC_DIR)/Networking/LwipEthernet/Lwip/test \
	$(DUET3CAN0_SRC_DIR)/DuetNG \
	$(DUET3CAN0_SRC_DIR)/Networking/LwipEthernet/Lwip/src/apps/tftp \
	$(DUET3CAN0_SRC_DIR)/Networking/W5500Ethernet \
	$(DUET3CAN0_SRC_DIR)/Networking/LwipEthernet/Lwip/src/netif/ppp \
	$(DUET3CAN0_SRC_DIR)/Networking/LwipEthernet/Lwip/src/apps/lwiperf \
	$(DUET3CAN0_SRC_DIR)/Networking/LwipEthernet/Lwip/src/apps/sntp \
	$(DUET3CAN0_SRC_DIR)/Display \
	$(DUET3CAN0_SRC_DIR)/Networking/LwipEthernet/Lwip/src/apps/http \
	$(DUET3CAN0_SRC_DIR)/Duet3Mini \
	$(DUET3CAN0_SRC_DIR)/Hardware/SAM4E \
	$(DUET3CAN0_SRC_DIR)/Hardware/SAME5x \
	$(DUET3CAN0_SRC_DIR)/Pccb \
	$(DUET3CAN0_SRC_DIR)/Networking/LwipEthernet/Lwip/src/apps/mqtt \
	$(DUET3CAN0_SRC_DIR)/Hardware/SAM4S \
	$(DUET3CAN0_SRC_DIR)/DuetM \
	$(DUET3CAN0_SRC_DIR)/Networking/LwipEthernet/Lwip/doc

DUET3CAN0_CPP_EXCLUDE_DIRS := $(DUET3CAN0_EXCLUDE_DIRS) \
	$(DUET3CAN0_SRC_DIR)/libcpp \
	$(DUET3CAN0_SRC_DIR)/Networking/LwipEthernet/Lwip/src/apps/httpd

DUET3CAN0_C_EXCLUDE_DIRS := $(DUET3CAN0_EXCLUDE_DIRS) \
	$(DUET3CAN0_SRC_DIR)/Networking/MQTT/MQTT_C/examples

DUET3CAN0_C_EXCLUDE_FILES := \
	$(DUET3CAN0_SRC_DIR)/Networking/MQTT/MQTT_C/tests.c \
	$(DUET3CAN0_SRC_DIR)/Networking/MQTT/MQTT_C/src/mqtt_pal.c

# Find all source files (excluding the directories and files listed above)
DUET3CAN0_CPP_SRCS := $(filter-out $(addsuffix /%,$(DUET3CAN0_CPP_EXCLUDE_DIRS)),$(call rwildcard,$(DUET3CAN0_SRC_DIR),*.cpp))

DUET3CAN0_C_SRCS := $(filter-out $(DUET3CAN0_C_EXCLUDE_FILES) $(addsuffix /%,$(DUET3CAN0_C_EXCLUDE_DIRS)),$(call rwildcard,$(DUET3CAN0_SRC_DIR),*.c))
